        ...
        <div id="how-to-buy">
            ...
            <div className="how-to-buy-container">
                ...
                <div className="how-to-buy-card">
                    ...
                    <p>
                        Visit <a href="https://pump.fun" target="_blank" rel="noopener noreferrer">pump.fun</a>, paste the contract address (CA), or follow the link to swap your SOL for $chillputin.
                    </p>
                </div>
            </div>
        </div>
